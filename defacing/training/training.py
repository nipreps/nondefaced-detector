...
class trainer(object):
    ...
    def train(self):
        ...
        for name in names:
            ...
            print(
                "No. of training and validation batches are:",
            ...
            self.model_checkpoint = ModelCheckpoint(
                os.path.join(self.model_save_path, name, "best-wts.h5"),
                monitor="val_loss",
                save_best_only=True,
    ...
    def fit(self, model, dataloaders, lr=1e-3):
        ...
        try:
            # pass
            model = multi_gpu_model(model, gpus=self.gpus, cpu_relocation=True)
        ...
        model.fit_generator(
            ...
            callbacks=[self.tbCallback, self.model_checkpoint],
