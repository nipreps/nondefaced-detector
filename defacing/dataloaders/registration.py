...
class Coregistration(object):
    ...
    def __init__(self):
        ...
        self.registration_method.SetMetricSamplingStrategy(
            self.registration_method.RANDOM
        )
    ...
    def resize_sitk_3D(
        self, image_array, outputSize=None, interpolator=sitk.sitkLinear
    ):
        """
    ...
    def register_patient(self, moving_image, fixed_image):
        """
        ...
        final_transform = self.registration_method.Execute(
